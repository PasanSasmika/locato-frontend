...
export default function Spa({ item }) {
    ...
    <View className="flex-1 bg-gray-100">
        <ScrollView className="p-4">
            <View className="bg-white rounded-xl p-5 mb-5 shadow-lg border border-gray-200">
                ...
                {renderInfoRow("sparkles-outline", "Services", item.services)}
                ...
                {renderInfoRow("construct-outline", "Facilities", item.facilities)}
                {renderInfoRow("alarm-outline", "Working Hours", item.workingHours)}
