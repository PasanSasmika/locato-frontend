...
export default function Saloon({ item }) {
    ...
    <View className="flex-1 bg-gray-100">
        <ScrollView className="p-4">
            <View className="bg-white rounded-xl p-5 mb-5 shadow-lg border border-gray-200">
                ...
                {renderInfoRow("time-outline", "Working Days", item.workingDays?.join(", "))}
                {renderInfoRow("bookmark-outline", "Appointments Needed", item.appointmentNeeded ? "Yes" : "No")}
            ...
            <View className="bg-white rounded-xl p-5 mb-5 shadow-lg border border-gray-200">
                ...
                >
                    ...
                    title={item.name || "Saloon Location"}
                    pinColor="#2563EB"
                    />
                </MapView>
                </View>
